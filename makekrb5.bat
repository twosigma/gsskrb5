...
set MKARGS=@%OPTSFILE%
set EXTRA_LIBS="kernel32.lib user32.lib advapi32.lib wsock32.lib netapi32.lib"
...
:compile_opt
set CFLAGS=%CFLAGS_OPT% %PLATFORM_CFLAGS% -DNDEBUG
set LFLAGS=%LFLAGS_OPT% %PLATFORM_LFLAGS% -DNDEBUG
